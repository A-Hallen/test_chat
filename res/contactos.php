...
$id_contactos     = mysqli_query($conection, "SELECT ID_CONTACTO FROM contactos WHERE id = '$a'");
...
$nombre_contactos = mysqli_query($conection, "SELECT Nombre FROM usuarios.usuarios WHERE id = '$numero[0]'");
...
if (!$id_contactos) {
    ...
    for ($i=0; $i < sizeof($nombre); $i++) { 
        ...
        <td class="td_nombre">', $numero[0][0]  ,  '</td>
        </tr>';
    }
}
